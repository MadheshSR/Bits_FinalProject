...
import com.mindtree.uiStore.HoliDaysUI;
import com.mindtree.utilities.ExtentLogUtilities;
import com.relevantcodes.extentreports.ExtentTest;

public class HoliDays extends HoliDaysUI {
    ...
    public HoliDays(WebDriver driver, Logger log, ExtentTest test) {
        this.driver = driver;
        this.log = log;
        this.test = test;
    }
    ...
    public void ins() throws ReusableComponentException, IOException {
        WebDriverSupport.click(driver, holiday, "Home Page", "Holidays", log, test);
        waitForStep();
